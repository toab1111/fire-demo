var formatDate = d3.timeFormat("%d %b %Y %- %H%:00");
...
function hue(h) {
    ...
    label
        .attr("x", x(h))
        .text(formatDate(h));
    console.log(String(h.getDate()) + " " + String(h.getMonth()) + " " + String(h.getFullYear()) + " " + String(h.getHours()));
}
